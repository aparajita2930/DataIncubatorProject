...
FILES = glob("F:/NYU/DataIncubator/Cancer/**/*13.mirna.quantification.txt")
print FILES.count
FILES.sort()
#print FILES
OUT_FILE = 'F:/NYU/DataIncubator/Cancer/output_file'
	...
	with open(file, 'r') as myFile:
		...
		for row in reader:
			try:
				...
				print "Exception wile reading line ", reader.line_num, " from file ", file, "  Expected a float. Got ", reads_per_million_miRNA_mapped
